...
python convert_double.py --midi_dir='./pretrain_data/Pop' --npy_dir='./pretrain_data_npy/Pop'
python convert_double.py --midi_dir='./pretrain_data/Jazz' --npy_dir='./pretrain_data_npy/Jazz'
python convert_double.py --midi_dir='./pretrain_data/Classic' --npy_dir='./pretrain_data_npy/Classic'
